...
export default function PurchasesClient({ initialData, initialError }: PurchasesClientProps) {
  const [documents, setDocuments] = useState<PurchaseDocument[]>(initialData)
