 ...
 *   node --import tsx lib/workers/index.ts
 * 
 * Or in production:
 *   node dist/lib/workers/index.js
 */
...
const workers = [pdfWorker, reportWorker, stockImportWorker, emailWorker, cacheWarmupWorker]
