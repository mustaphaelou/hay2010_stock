...
interface StockViewProps {
    initialStockLevels: EnhancedArtstock[]
    initialDepots: FDepot[]
}

export function StockView({ initialStockLevels, initialDepots }: StockViewProps) {
    const [stockLevels, setStockLevels] = useState<EnhancedArtstock[]>(initialStockLevels)
    const [depots, setDepots] = useState<FDepot[]>(initialDepots)
