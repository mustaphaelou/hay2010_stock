...
interface AffairesViewProps {
    initialAffaires: string[]
}

export function AffairesView({ initialAffaires }: AffairesViewProps) {
    const [affaires, setAffaires] = useState<string[]>(initialAffaires)
    const [selectedAffaire, setSelectedAffaire] = useState<string>(initialAffaires[0] || '')
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="flex items-center gap-4">
                                ...
                                <Button variant="outline" size="icon" onClick={fetchAffaires} disabled={loading}>
