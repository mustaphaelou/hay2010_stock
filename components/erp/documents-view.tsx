...
interface DocumentsViewProps {
    initialData: DocumentWithPartner[]
}

export function DocumentsView({ initialData }: DocumentsViewProps) {
    const [documents, setDocuments] = useState<DocumentWithPartner[]>(initialData)
            ...
            <div className="flex flex-1 flex-col gap-6">
                ...
                <div className="grid gap-4 md:grid-cols-4">
                    ...
                    <Card className="bg-gradient-to-br from-green-500/10 to-green-500/5 border-green-500/20">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{formatPrice(totalVentes)}</div>
